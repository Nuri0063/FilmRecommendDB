    ...
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("Programı sonlandırmak için 1'e basın."); //Programa dinamiklik vermek için döngü çıkışları verdim
                Console.WriteLine("Seçime devam etmek  için 2'e basın.  ");
                int cıkıs=Convert.ToInt32(Console.ReadLine());
                if (cıkıs == 1)
                    break;
                else if(cıkıs==2)
                    continue;
